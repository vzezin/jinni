It started between the authors: "Hey, what did you write in this prompt? Did you skip your Jinni Operations at Quantico?!" — "WUT?.. Never been there!.."

So we had to write it: a Jinni Engineering Field Manual, for those who never attended but spawn AI agents daily.
...
Each of those is a natural clause of the Jinni Engineering Field Manual's contract anatomy illustration — the circle (§6.10), the true name (§2), the ends and the floors (§6), the valve and the recall (§6.7), the guard notice at the ~~door~~ code repository (§9). Now it is everywhere: every agent, subagent, skill, and system prompt. Laugh here: humans run it too, naturally.

What the old practice knew and the manual states plainly: *dumb specifying harder makes it worse*. Precision goes on the ends; the reason travels with every clause; and there shall always be a sanctioned way to stop and report, because ***a jinni with no honorable exit goes inventive or fabricates one***. That is what lets you hand work to many hands you cannot watch and get honest work back.
